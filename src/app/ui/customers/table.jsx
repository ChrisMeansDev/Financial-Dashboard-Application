...
export default async function CustomersTable({ customers = [] }) {
  // Ensure customers is always an array to avoid runtime errors
                    ...
                    >
                      <div className="flex items-center justify-between border-b pb-4">
                        <div>
                          <div className="mb-2 flex items-center gap-3">
                            <Image
                              src={customer.image_url || '/placeholder.png'}
                              className="rounded-full"
                              alt={`${customer.name || 'Customer'}'s profile picture`}
                              width={28}
                              height={28}
                            />
                      ...
                      <div className="flex w-full items-center justify-between border-b py-5">
                        <div className="flex w-1/2 flex-col">
                          ...
                          <p className="font-medium">{customer.total_pending || 0}</p>
                        </div>
                        <div className="flex w-1/2 flex-col">
                          <p className="text-xs">Paid</p>
                          <p className="font-medium">{customer.total_paid || 0}</p>
                        </div>
                      </div>
